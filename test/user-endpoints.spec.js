    ...
    describe(`Given a valid user`, () => {
      ...
      it(`inserts 1 language with words for the new user`, () => {
        ...
        const expectedList = {
          ...
          total_score: 0,
          words: [
            { original: 'banheiro', translation: 'restroom' },
            { original: 'obrigado', translation: 'thank you' },
            { original: 'adeus', translation: 'goodbye' },
            { original: 'macaco', translation: 'monkey' },
            { original: 'vinho', translation: 'wine' },
            { original: 'madrugada', translation: 'dawn' },
            { original: 'cachorro', translation: 'dog' },
            { original: 'jantar', translation: 'dinner' },
            { original: 'sobremesa', translation: 'dessert' },
            { original: 'namorado', translation: 'boyfriend' },
            { original: 'cavalo', translation: 'horse' },
            { original: 'filme', translation: 'movie' },
            { original: 'doce', translation: 'sweet' },
            { original: 'massa', translation: 'pasta' },
            { original: 'sorvete', translation: 'ice cream' },
          ]
        }
        return supertest(app)
          .post('/api/user')
